...
func (s *Store) GenerateAgentsMD() (string, error) {
	...
	b.WriteString("# AGENTS.md\n<!-- Auto-generated by memorX. Do not edit manually. -->\n<!-- Regenerate with: memorx_generate_rules -->\n\n")
	...
	b.WriteString("## Session Protocol\n\nAt the start of every session, call memorx_briefing to load context.\nWhen making decisions, call memorx_remember with type=\"decision\".\nBefore ending a session, call memorx_end_session with a summary.\n")
	return b.String(), nil
}
